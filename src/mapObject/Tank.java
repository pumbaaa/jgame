...
public class Tank extends MapObject {
  ...
  public Tank(GameStateManager sm) {
    super(sm);
    ...
    // TILEDATA
    {
      ...
      animation[ANIM_LEFT] = new Animation((11 * 32 + 21), 2);
      animation[ANIM_STANDBY] = new Animation((11 * 32 + 21), 2);
      animation[ANIM_RIGHT] = new Animation((11 * 32 + 21), 2);
      animation[ANIM_DEATH] = new Animation((12 * 32 + 21), 11);
